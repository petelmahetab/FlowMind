...
import { X, FileBarChart, Download, Users, Clock, AlertTriangle } from "lucide-react";
...
export default function AuditReportModal({ sopId, onClose }: Props) {
  ...
  async function handleExportPdf() {
    ...
    try {
      ...
      const lowRiskSteps = data.stepBreakdown.filter((s) => s.completionRate < 70);
          ...
          <table style="width:100%;border-collapse:collapse;font-size:12px;">
            ...
            ${data.runs
              ...
              <tr style="border-bottom:1px solid #f3f4f6;">
                ...
                <td style="padding:8px;color:#111827;text-transform:capitalize;">${r.status.replace("_", " ")}</td>
        ...
        <div className="overflow-y-auto flex-1 p-5">
          {loading ? (
            ...
            <>
              ...
              {data.stepBreakdown.some((s) => s.completionRate < 70) && (
                <div className="mb-5">
                  <div className="flex items-center gap-1.5 mb-2">
                    <AlertTriangle className="w-3.5 h-3.5 text-red-500" />
                    <p className="text-xs font-medium text-gray-700 dark:text-gray-300">Frequently skipped steps</p>
                  </div>
